...
export function Profile() {
  ...
  const handleSavePassword = async (e: React.FormEvent) => {
    ...
    try {
      await updateUser(state.userName, newPassword);
      ...
      <div className="bg-surface border border-surfaceHighlight rounded-2xl p-5 mb-5 relative overflow-hidden shadow-lg">
            ...
            {isEditingName ? (
              <div className="flex items-center gap-2 mb-1">
                <input
                  ...
                  className="bg-background border border-safe/50 text-white px-2.5 py-1 rounded-lg text-sm w-full font-bold focus:outline-none focus:border-safe"
                ...
                <button
                  ...
                  disabled={nameSaving}
                  className="p-1.5 bg-safe text-black rounded-lg hover:bg-emerald-400 transition-colors"
                >
                ...
                <button
                  ...
                  className="p-1.5 bg-surfaceHighlight text-textMuted rounded-lg hover:text-white transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1 text-textMuted hover:text-safe transition-colors"
                  title="Edit Name"
                >
        ...
        {nameSuccess && (
          <motion.div
            ...
            className="mt-3 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs py-1.5 px-3 rounded-lg text-center font-medium"
          >
